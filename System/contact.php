...
<head>
	...
	<title>Amployment Jobs - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Amployment Jobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								...
								<li>
										<h5>Email</h5><a href="mailto:Amployment.nath2@gmail.com">Amployment.nath2@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Amployment Jobs</h5>
											<p>Amployment Jobs is a job portal, online job management system developed by Anmol , khushi for his project in february 2018.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Amployment Jobs Contact</h5>
								
								<p>Address : Takoradi, School Junction PO.BOX AX40</p>
								<p>Email : <a href="mailto:Amployment.nath2@gmail.com">Amployment.nath2@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Amployment Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Anmol , khushi</a></li>
								</ul>
